...
namespace FMS
{
    public class MyMembershipProvider: MembershipProvider
    {
        ...
        {
            using (FMSEntities dc = new FMSEntities())
            {
                var user = dc.FMSUsers.Where(a => a.Email.Equals(username) && a.Password.Equals(oldPassword)).FirstOrDefault();
                if (user != null)
                {
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            using (FMSEntities dc = new FMSEntities())
            {
                var user = dc.FMSUsers.Where(a => a.Email.Equals(username) && a.Password.Equals(password)).FirstOrDefault();
                if (user != null)
                {
                    return true;
                }
